    ...
    return (
      <View style={styles.container}>
        ...
        {!visibleForm && !isLoggedIn && (
          <Opening
            onCreateAccountPress={() => this.setState({visibleForm: 'SIGNUP'})}
            onSignInPress={() => this.setState({visibleForm: 'LOGIN'})}
          />
        )}
        <View style={[formStyle, styles.bottom]}>
          {visibleForm === 'SIGNUP' && (
            <SignupForm
              ...
              onLoginLinkPress={() => this.setState({visibleForm: 'LOGIN'})}
          ...
          {visibleForm === 'LOGIN' && (
            <LoginForm
              ref={(ref) => (this.formRef = ref)}
              onSignupLinkPress={() => this.setState({visibleForm: 'SIGNUP'})}
              onLoginPress={login}
              isLoading={isLoading}
